...
(function() {
  $(function() {
    return $('#tweet_body').on('input', function() {
      var bodyLength, newLineCharactors, remainsLength, textCharactors;
      ...
      if (remainsLength > window.cpTwitter.WARNING_REMAINS_LENGTH_TWEET) {
        return $('#tweet_body_length').html(remainsLength).removeClass("text-warning");
      } else {
        return $('#tweet_body_length').html(remainsLength).addClass("text-warning");
      }
    });
  });
...
(function() {
  $(function() {
    return $('.card-tweet .card-header').on('click', function() {
      var $tweetLink;
      $tweetLink = $('a[data-show-tweet]', this)[0];
      if ($tweetLink != null) {
        return $tweetLink.click();
      }
    });
  });
