...
RSpec.describe FollowingController, type: :controller do
  ...
  # FollowingController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all following as @following" do
  ...
  describe "GET #new" do
    it "assigns a new following as @following" do
      ...
      expect(assigns(:following)).to be_a_new(Following)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created following as @following" do
        post :create, {:following => valid_attributes}, valid_session
        expect(assigns(:following)).to be_a(Following)
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved following as @following" do
        post :create, {:following => invalid_attributes}, valid_session
        expect(assigns(:following)).to be_a_new(Following)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested following" do
        following = Following.create! valid_attributes
        put :update, {:id => following.to_param, :following => new_attributes}, valid_session
        following.reload
    ...
    context "with invalid params" do
      it "assigns the following as @following" do
        following = Following.create! valid_attributes
        put :update, {:id => following.to_param, :following => invalid_attributes}, valid_session
        expect(assigns(:following)).to eq(following)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the following list" do
      following = Following.create! valid_attributes
      delete :destroy, {:id => following.to_param}, valid_session
      expect(response).to redirect_to(following_index_url)
    end
  end
